...
# MEMORY MANAGEMENT
- 会話の中でタスクの進行状況、重要な決定事項、ユーザーの好みなど、記憶すべきと判断した情報がある場合は、必ずユーザーに確認した上で `save_memory` ツールを使用して記憶してください。


# TASK MANAGEMENT
- すべてのタスクと計画は `TODO.md` で管理してください。
- 作業を開始する前、および完了した後は、必ず `TODO.md` を参照・更新して最新の状態を保ってください。
